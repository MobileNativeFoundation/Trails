...
class PagingTests {
    ...
    fun singleLoad() = testScope.runTest {
        ...
        pager.state.test {
            ...
            assertEquals(initialPagingParams.copy(after = 51), secondPagingState.next)
        }
    }
    ...
    fun multipleLoads() = testScope.runTest {
        ...
        fun getNextPagingKey(after: Int?) = PostPagingKey.Page(initialPagingParams.copy(after = after))
        ...
        pager.state.test {
            ...
            pager.load(getNextPagingKey(secondPagingState.next?.after))
            ...
            assertEquals(initialPagingParams.copy(after = 102), thirdPagingState.next)

            pager.load(getNextPagingKey(thirdPagingState.next?.after))
            ...
            assertEquals(initialPagingParams.copy(after = 153), fourthPagingState.next)
        }
    }
